...
public class JdomBuilder
{
  ...
  public static Scriptable jdomBuilder(Scriptable scope, Object start) {
    return builderWrapper(scope, start instanceof Document?
        new JdomBuilder((Document)start) : new JdomBuilder((Element)start));
  }
  public static Scriptable jdomBuilder(Scriptable scope, String root, Namespace ns) {
    return builderWrapper(scope, new JdomBuilder(root, ns));
  }
  ...
  public JdomBuilder emptyel(String name, Object... atts) {
